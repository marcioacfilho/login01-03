                ...
                <div class="col-md-6">
                    ...
                    <div class="mt-1">
                        <select class="form-select">
                            <option selected>Selecione uma pergunta de segurança

                            <option>Qual o estação do ano que você nasceu?</option>
                    ...
                    <button type="submit" class=" btn btn-primary w-50 mt-3">Cadastro</button>
